...
module.exports = {
  ...
  OWNER_NAME: process.env.OWNER_NAME |NAYTIC_GILL| "Eʏᴘᴢ",
  BOT_NAME: process.env.BOT_NAME |NAYTIC_BOT| "Iᴢᴜᴍɪ-ᴍᴅ",
  SUDO: process.env.SUDO || null,
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME |NAYTIC_GILL| "Iᴢᴜᴍɪ-ᴍᴅ,Eʏᴘᴢ",
